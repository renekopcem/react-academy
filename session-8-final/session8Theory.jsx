        ...
        <div className="concept-block">
          ...
          <div className="info-box warning">
            ...
            <p>
              ...
              simply because their parent re-rendered. With 1000 list items,
              this can cause visible lag!
            </p>
          </div>
  ...
  return <ChildComponent onClick={handleClick} />;
        ...
        <div className="concept-block">
          ...
          <p>
            ...
            inputs haven't changed. React provides three main memoization tools:
          </p>
...
const TeamMember = React.memo(function TeamMember({ member }) {
  return <div>{member.name}</div>;
          ...
          <p>
            Caches the result of expensive computations and only recalculates
...
const filtered = useMemo(() => {
  return members.filter(m => expensiveCheck(m));
          ...
          <p>
            ...
            dependencies change. Critical for passing stable function references
            to child components.
          </p>
...
const handleDelete = useCallback((id) => {
  deleteMember(id);
          ...
          <div className="info-box tip">
            ...
            <ul>
              <li>
                <strong>React.memo</strong>: Wrap child components that receive
                props
              </li>
              <li>
        ...
        <div className="concept-block">
          ...
          <p>
            Don't guess - measure! React and Chrome provide powerful tools to
            identify performance bottlenecks.
          </p>
          <p>
            Use React DevTools Profiler and Chrome Performance tab to find and
        ...
        <div className="concept-block">
          ...
          <p>
            ...
            that load on demand, reducing initial bundle size and improving load
            time.
          </p>
      ...
      <section className="practice-section">
        ...
        <p>
          In the practice session, you'll work with a team directory containing{' '}
          <strong>1000 members</strong> that has significant performance issues.
          We'll use React DevTools Profiler to identify problems, then
          systematically apply optimizations:
        </p>
